<%@ page language="C#" autoeventwireup="true" inherits="qa_loadmy, App_Web_nasjltov" %><!DOCTYPE html>
<%
    //AJAX加载更多我的问题
    int pageNo = 1;
    ...
    var questions = BLL.Question.GetMyQuestions(userid, Request.QueryString["tag"], pageNo, 15, out pagecount, out totalCount);
         %>
    ...
    <td class="title">
        ...
        <div class="tags">
            <%foreach(var tag in question["tags"].AsBsonArray){ %>
                <a href="my.aspx?tag=<%=tag.AsString %>"><%=tag.AsString %></a>
            <%} %>
        </div>
